...
Loop over multiple arrays and create a new array whose  ith
  element is the concatenation of  ith
  element of each of the given.
...
function loopSimult(A) {
   ...
   {res.push(A.map((item)=>item[i]).join(""));}
   return res;
}
